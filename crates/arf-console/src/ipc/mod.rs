...
fn arf_session_base(meta: &SessionMeta) -> SessionResult {
    SessionResult {
        ...
        ipc_policy: meta.ipc_policy.clone(),
        r: None,
...
pub(in crate::ipc) fn set_session_meta(
    ...
    let meta = SessionMeta {
        ...
        log_file,
        history_session_id,
        ipc_policy: policy::policy(session_type),
    };
...
fn current_session_meta() -> SessionMeta {
    match SESSION_META.get() {
        ...
        None => SessionMeta {
            ...
            ipc_policy: policy::policy(session::SessionType::Interactive),
        },
    }
}
